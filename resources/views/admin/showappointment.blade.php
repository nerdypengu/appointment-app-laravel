        ...
        <div align="center" style="padding:100px">
            <table>
                ...
                <tr style="background-color:#DCDCDC;" align="center">
                    ...
                    <td><a class="bt btn-success" style="padding:5px;" href="{{url('approved',$appoint->id)}}">Approved</a></td>
                    <td><a class="bt btn-danger" style="padding:5px;" href="{{url('canceled',$appoint->id)}}">Canceled</a></td>
                    <td><a class="bt btn-primary" style="padding:6px;" href="{{url('emailview',$appoint->id)}}">Send Mail</a></td>
                </tr>
            @endforeach
