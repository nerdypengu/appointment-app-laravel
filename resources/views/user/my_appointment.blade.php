    ...
    <div align="center" style="padding:70px;">
        <table>
            ...
            <tr style="background-color:#DCDCDC;" align="center">
                ...
                <td><a class="bt btn-danger" style="padding:5px;" onclick="return confirm('Are you sure you want to delete this ?')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
            </tr>
            @endforeach
        </table>
    </div>
